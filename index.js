...
Do you follow it, or continue on your path?`)
    ...
    let secondAnswer = window.prompt(`You come across a snoring dragon. On the other side of him, you see a shin chest of treasure. Another path would lead you away from the dragon altogether. Which path do you take?`)

} if(secondAnswer === 'past the dragon'){
let thirAnswer = window.prompt('The dragon wakes up and sits upright. You only have a moment to respond, to stay or run:')
...
}else if(thirdAnswer === 'pick it' && 'draw it'){
    let fourthAnswer = window.alert('You draw the flower, and then you pick it once your done. You bring it home and frame the flower to capture the physical memory of it.')
}
